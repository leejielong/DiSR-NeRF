...
from threestudio.models.networks import get_encoding, get_mlp, create_network_with_input_encoding
from threestudio.utils.ops import get_activation
from threestudio.utils.typing import *


@threestudio.register("ngp-volume")
class NGPVolume(BaseImplicitGeometry):
    @dataclass
    ...
    def configure(self) -> None:
        ...
        self.encoding_with_network = create_network_with_input_encoding(self.cfg.n_input_dims, 
    ...
    def forward(
        ...
        out = self.encoding_with_network(points.view(-1, self.cfg.n_input_dims)).view(*points.shape[:-1], self.cfg.n_feature_dims).float()
        density, features = out[...,:1], out # density takes 1st feature of feature vector.
    ...
    def create_from(
        ...
        **kwargs,
        ...
        if isinstance(other, NGPVolume):
            instance = NGPVolume(cfg, **kwargs)
            ...
            raise TypeError(
                f"Cannot create {NGPVolume.__name__} from {other.__class__.__name__}"
            )
